...
public class HibernateDAO {
    ...
    @Transactional
    public void criaLog(Usuario usuario, Long idObjeto, String classe,
                        @DateTimeFormat(pattern = "dd/MM/yyyy HH:mm") Date dataHora, String tipo) throws ClassNotFoundException {
        Log log = new Log();
    ...
    public Object criaObjeto(Object o) {
        sessionFactory.getCurrentSession().save(o);
        Object teste= sessionFactory.getCurrentSession().merge(o);
