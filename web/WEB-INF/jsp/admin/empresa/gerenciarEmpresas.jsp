    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-hover table-condensed table table-striped">
                <thead>
                <tr>
                    <td class="text-center"><button data-toggle="modal" data-target="#adicionar" type="button" class="btn btn-success" title="Adicionar Empresa">
                        <i class="fa fa-plus-square-o"><strong> Adicionar Empresa</strong></i>
                    </button></td>
                ...
                <tbody>
                <tr ng-repeat="empresa in empresas | orderBy:'razaoSocial'">
                    <form>
                        <td class="text-muted text-center"width="8%">{{empresa.razaoSocial}}</td>
                        <td class="text-muted text-center"width="7%">{{empresa.cnpj}}</td>
                        <td class="text-muted text-center"width="7%">{{empresa.representanteEmpresa.nome}}</td>
                        <td class="text-muted text-center"width="10%">
                            <div class="form-group">
                                ...
                                <button class="btn btn-primary" data-toggle="modal" data-target="#editar" ng-click="openModal(empresa)"
                                        title="Editar Empresa"><i class="fa fa-edit"></i></button> -
                                <button class="btn btn-danger" ng-click="deleteEmpresa(empresa)"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body col-md-12">
                ...
                <form action="criaEmpresa.priv" method="post" autocomplete="off" name="formCadastro">
                    <div class="form-group col-md-12">
                        <label class="sr-only">Razão Social</label>
                        <input type="text" name="razaoSocial" minlength="5" maxlength="30" placeholder="Razão social da empresa" class="form-control" required>
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="number" name="numero" maxlength="10" placeholder="Número" class="form-control" required>
                    </div>
                    <br>
                    <hr>
                    <h3>Representante</h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body col-md-12">
                ...
                <form autocomplete="off" name="formEditar">
                    <div class="form-group col-md-12">
                        <label class="sr-only">Razão Social</label>
                        <input type="text" ng-model="empresaEditar.razaoSocial" name="razaoSocial" minlength="5" maxlength="20" placeholder="Razão social da empresa" class="form-control" required>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="sr-only">Cnpj</label>
                        <input type="text" ng-model="empresaEditar.cnpj" name="cnpj" minlength="14" maxlength="20" placeholder="Insira o cnpj" class="form-control" required>
                    </div>
                    <br>
                    <hr>
                    <h3>Endereço</h3>
                    <div class="form-group col-md-6">
                        <label class="sr-only">UF</label>
                        <input type="text" ng-model="empresaEditar.endereco.uf" name="uf" minlength="2" maxlength="2" placeholder="Insira a uf. EX: RS" class="form-control" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="sr-only">Cidade</label>
                        <input type="text" ng-model="empresaEditar.endereco.cidade" name="cidade" minlength="5" maxlength="20" placeholder="Cidade" class="form-control" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="sr-only">Bairro</label>
                        <input type="text" ng-model="empresaEditar.endereco.bairro" name="bairro" minlength="5" maxlength="20" placeholder="Bairro" class="form-control" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="sr-only">Rua</label>
                        <input type="text" ng-model="empresaEditar.endereco.rua" name="rua" minlength="5" maxlength="20" placeholder="Rua" class="form-control" required>
                    </div>

                    <div class="form-group col-md-12">
                        <label class="sr-only">Número</label>
                        <input type="text" ng-model="empresaEditar.endereco.numero" name="numero" maxlength="5" placeholder="Número" class="form-control" required>
                    </div>
                    <br>
                    <hr>
                    <h3>Representante</h3>
                    <div class="form-group col-md-6">
                        <label class="sr-only">Nome</label>
                        <input type="text" ng-model="empresaEditar.representanteEmpresa.nome" name="nome" minlength="5" maxlength="20" placeholder="Nome Completo" class="form-control" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="sr-only">Email</label>
                        <input type="email" ng-model="empresaEditar.representanteEmpresa.email" name="email" minlength="5" maxlength="30" placeholder="Insira seu email" class="form-control" required>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="sr-only">Login</label>
                        <input type="text" ng-model="empresaEditar.representanteEmpresa.login" name="login" minlength="5" maxlength="20" placeholder="login" class="form-control" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label class="sr-only">Senha</label>
                        <input type="password" name="senha" minlength="6" maxlength="20" placeholder="Senha" ng-model="empresaEditar.representanteEmpresa.senha" class="form-control" required>
                        <div ng-if="formCadastro.senha.$dirty">
                            <div ng-if="formCadastro.senha.$invalid">
                                <p style="color: red; margin-left:5%;">  a senha deve ter no m&iacute;nimo seis caracteres</p>
                            </div>
                    ...
                    <div class="form-group col-md-6">
                        <label class="sr-only">Confirme sua senha</label>
                        <input type="password" minlength="6" maxlength="20" placeholder="Confirme sua senha" name="confirmarSenha" ng-model="empresaEditar.representanteEmpresa.confirmarSenha" class="form-control" required>

                    </div>

                    <div class="col-md-12" ng-if="formEditar.confirmarSenha.$dirty && formEditar.confirmarSenha.$valid">
                        <div ng-if="empresaEditar.representanteEmpresa.senha != empresaEditar.representanteEmpresa.confirmarSenha" class="alert alert-danger" role="alert">
                            <strong><span class="fa fa-close"></span> Opa! &nbsp</strong> Senhas n&atilde;o correspondem!
                        </div>
                        <div ng-if="empresaEditar.representanteEmpresa.senha && empresaEditar.representanteEmpresa.confirmarSenha && empresaEditar.representanteEmpresa.senha == empresaEditar.representanteEmpresa.confirmarSenha && empresaEditar.representanteEmpresa.confirmarSenha.length >5" class="alert alert-success" role="alert">
                            <strong><span class="glyphicon glyphicon-ok"></span> Ok! &nbsp</strong> As senhas correspondem!
                        </div>
                    </div>

                    <br>
                    <button type="submit" ng-click="editarEmpresa(laboratioEditar)" data-dismiss="modal" class="btn btn-success">Salvar</button>
                </form>
            </div>
